...
local script = sss.Core:FindFirstChild("PersistentNPCSpawner")
if not script then print("PersistentNPCSpawner: NOT FOUND") return end
script.Source = [[-- NPCController (PersistentNPCSpawner)
...
local ok = script.Source:find("SpawnTutorialNPC", 1, true) and "YES" or "NO"
print("PersistentNPCSpawner pushed. SpawnTutorialNPC:", ok)
