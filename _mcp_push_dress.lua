...
local ds = sss:FindFirstChild("Minigames") and sss:FindFirstChild("Minigames"):FindFirstChild("DressStationServer")
if not ds then error("DressStationServer not found") end
ds.Source = [=[
...
print("Source updated, length=", #ds.Source)
