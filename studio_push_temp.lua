...
local minigamesFolder = sps:FindFirstChild("Minigames")
local dc = minigamesFolder:FindFirstChild("DressStationClient")
if not dc then error("DressStationClient not found!") end
dc.Source = [==[
...
print("DressStationClient updated. Length: " .. #dc.Source)