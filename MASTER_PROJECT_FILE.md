...
| BUG-43 | 🟠 High | All Minigame UIs | All 4 minigame exit buttons use `exitBtn.Text = "✕"` (Unicode U+2715 multiplication sign). This character renders as a hollow white box on some Roblox clients/platforms, making the button look broken ("red square with white square"). Fix: replace "✕" with plain ASCII "X" in MixMinigame, DoughMinigame, OvenMinigame, FrostMinigame. | 🟡 In Progress — Session 11 |
