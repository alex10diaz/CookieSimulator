...
-- All payout formulas live here. Rebalance by changing numbers in this one file.
...
--[[
    ...
    @param timeRemaining number  (seconds left on delivery)
    @param totalTime     number  (original time limit in seconds)
