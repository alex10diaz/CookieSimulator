...
local function applyHudWidgetLayout()
    ...
    hudWidget.Position = compact and UDim2.new(0, 10, 1, -126) or UDim2.new(0, 10, 1, -202)
...
local function connectViewportResize()
    ...
    if weeklyViewportConn then
        weeklyViewportConn:Disconnect()
    end
    weeklyViewportConn = camera:GetPropertyChangedSignal("ViewportSize"):Connect(applyHudWidgetLayout)
end
